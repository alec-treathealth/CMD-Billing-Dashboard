 ...
 * consumed (collections data is BXR-or-stub until the data layer lands). `canRevealPhi`
 * (admins + super-admins) toggles the audited "Reveal all" control; a plain user never sees it.
 */
...
export function CollectionsView({
  ...
  return <CmdCollectionsExplorer canRevealPhi={canRevealPhi} />;
}

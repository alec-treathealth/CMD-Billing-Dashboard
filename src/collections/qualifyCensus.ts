...
export function buildQualifyCensusReadQuery(businessEntityIds: string[]): { sql: string; params: unknown[] } {
  return {
    sql:
      ...
      'from collections.qualify_facility_census where business_entity_id = any($1::uuid[])',
    params: [businessEntityIds],
  };
}
